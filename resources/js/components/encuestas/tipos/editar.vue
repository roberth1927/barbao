<template>
    <b-container fluid>
        ...
        <b-form @submit="guardarDatos">
            ...
            <b-form-group id="grupoNombre" label="Nombres:" label-for="nombre">
                ...
                <div v-if="$v.nombre.$dirty"><p class="error-message" v-if="!$v.nombre.required">El nombre del tipo de encuesta es obligatorio</p></div>
            </b-form-group>
    ...
    export default {
        ...
        methods: {
            ...
            guardarDatos(evt){
                ...
                evt.preventDefault();
                this.errors = []
                axios.put('/auth/encuestas/tipos/' + this.id, {
                    nombre: this.nombre,
