    ...
    <b-container fluid>
        ...
        <b-form @submit="guardarDatos">
            ...
            <b-form-group id="grupoEncuesta" label="Encuesta" label-for="encuesta">
                <b-form-select id="encuesta" :options="encuestas" v-model="encuestas_id" @input="$v.encuestas_id.$touch()" disabled></b-form-select>
    ...
    export default {
        ...
        methods: {
            ...
            guardarDatos(evt){
                ...
                evt.preventDefault();
                this.errors = []
                axios.put('/auth/encuestas/preguntas/' + this.id + '/' + this.encuestas_id + '/' + this.empresas_id, {     
